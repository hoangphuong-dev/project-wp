...
$wp_customize->add_section( 'ecommerce_plus_home_section', array(
	'title'             => __( 'Show | Hide | Order Sections','ecommerce-plus' ),
	'description'       => __( 'Show | Hide | Order Home Sections. First create a page from home-page-template and set as home page. Then open customizer. Download and Install eCommerce plugin from our theme page for more sections such as testimonial, service etc.', 'ecommerce-plus' ),
