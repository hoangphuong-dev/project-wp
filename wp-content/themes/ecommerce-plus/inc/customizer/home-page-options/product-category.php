...
$wp_customize->add_section( 'ecommerce_plus_product_category_section', array(
	...
	'description'       => esc_html__( 'Featured Category Section Options. First create a page from home-page-template and set as home page. Then open customizer.', 'ecommerce-plus' ),
